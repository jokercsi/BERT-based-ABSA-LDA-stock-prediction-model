...
def parser_args():
    ...
    parser.add_argument("-graph", "--graph", default="./../../data/result/short")
...
def test(args):
    ...
    _, _, _, _, _, _, _, _, X_test_t, X_test_n, y_test = data_load(
        path_pkl + args.text, path_pkl + args.num, seq_len
    )
